/****************************************************************************
** Meta object code from reading C++ file 'potatomine.h'
**
...
#include <memory>
#include "../../TD/potatomine.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'potatomine.h' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject PotatoMine::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_PotatoMine.data,
    qt_meta_data_PotatoMine,
    qt_static_metacall,
    nullptr,
    nullptr
} };
