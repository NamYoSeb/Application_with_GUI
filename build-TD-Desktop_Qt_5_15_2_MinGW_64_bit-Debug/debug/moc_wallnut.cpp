/****************************************************************************
** Meta object code from reading C++ file 'wallnut.h'
**
...
#include <memory>
#include "../../TD/wallnut.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'wallnut.h' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject Wallnut::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Wallnut.data,
    qt_meta_data_Wallnut,
    qt_static_metacall,
    nullptr,
    nullptr
} };
